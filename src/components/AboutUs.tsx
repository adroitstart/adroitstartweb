    ...
    <section className="py-16" id="about-us" style={{ paddingTop: "12vh", marginTop: "-12vh" }}>
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 flex flex-wrap gap-6">
            <div className="w-full m-4 bg-white rounded-lg shadow-lg">
              <h2 className="text-3xl p-4 font-semibold mb-6 text-adroitBlue">
                Who We Are
              </h2>
            ...
            <div className="m-4 w-full m-8 bg-white rounded-lg shadow-lg">
