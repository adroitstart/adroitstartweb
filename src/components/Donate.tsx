const Donate = () => {
    return (
      <section className="bg-gray-100" id="donate">
        <div className="relative h-screen flex items-center justify-center overflow-hidden grid grid-cols-1 md:grid-cols-3 content-end bg-[url('/images/slide-7.jpg')] bg-cover">
            <div></div>
            <div className="mt-24">
