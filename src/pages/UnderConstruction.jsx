       ...
       {/*  <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
        ...
        {/* <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}> */}
          <div className="relative pb-9/16">
            <img className="absolute w-full h-full" src={Robot} width="540" height="405" alt="Robot" />
            {/* <iframe className="absolute w-full h-full" src="https://www.youtube.com/embed/DasJsXyBh6A" title="FRC Promo 2021" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> */}
            {/* <iframe className="absolute w-full h-full" src="https://www.youtube.com/embed/DasJsXyBh6A2" title="Video" allowFullScreen></iframe> */}
          </div>
        {/* </Modal> */}
      </div>
    </div>
